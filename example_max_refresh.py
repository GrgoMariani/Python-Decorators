...
""" --------------||||||||||||||---------------"""
""" FIRST EXAMPLE """
@max_refresh("ExampleFunc1", 1)
def first():
    print("This should be printed every 1 second")

@max_refresh("ExampleFunc2", 3)
def second():
...
""" --------------||||||||||||||---------------"""
""" THIRD EXAMPLE"""
@max_refresh("ExampleFunc4", 1)
def increment1(integer):
    return integer+1

@max_refresh("ExampleFunc5", 3)
def arrayof(integer):
    return [integer]
